...
export const chapterGlossaries = {
  ...
  14: [
    { term: "Correlation", definition: "A statistical technique that is used to measure and describe the relationship between two variables. A correlation describes three characteristics: the direction, the form, and the strength of the relationship." },
    { term: "Scatterplot", definition: "A graph that displays data points for two variables. Values for the X variable are listed on the horizontal axis and Y values on the vertical axis. Each individual is represented by a single point, allowing you to see any patterns or trends that exist in the data." },
    { term: "Positive correlation", definition: "A relationship in which the two variables tend to change in the same direction: as the value of the X variable increases, the Y variable also tends to increase; when X decreases, Y also decreases." },
    { term: "Negative correlation", definition: "A relationship in which the two variables tend to go in opposite directions. As the X variable increases, the Y variable decreases. That is, it is an inverse relationship." },
    { term: "Perfect correlation", definition: "A correlation of exactly +1.00 or −1.00, indicating a perfectly consistent relationship. Each change in X is accompanied by a perfectly predictable change in Y." },
    { term: "Pearson correlation", definition: "A measure of the degree and direction of the linear relationship between two variables — that is, how well the data points fit on a straight line." },
    { term: "Pearson correlation coefficient (r)", definition: "The Pearson correlation for a sample, identified by the letter r. Values range from −1.00 to +1.00, where the sign indicates direction and the absolute value indicates strength." },
    { term: "Rho (ρ)", definition: "The Greek letter used to identify the Pearson correlation for the entire population. The sample correlation r is used to estimate ρ." },
    { term: "Linear relationship", definition: "A relationship between two variables where the data points cluster around a straight line. The Pearson correlation specifically measures the degree and direction of this type of relationship." },
    { term: "Coefficient of determination (r²)", definition: "The squared value of the Pearson correlation. It measures the proportion of variability in one variable that can be determined from the relationship with the other variable." },
    { term: "Simple linear regression", definition: "A statistical technique that provides a standardized method for determining the best-fitting straight line for a set of data, used to predict Y from X." },
    { term: "Linear equation", definition: "A relationship between two variables X and Y expressed by the equation Y = bX + a, where a and b are fixed constants that define a straight line." },
    { term: "Slope (b)", definition: "The value of b in the linear equation. The slope determines how much the Y variable changes when X is increased by one point. Computed as b = SP/SSₓ." },
    { term: "Y-intercept (a)", definition: "The value of a in the linear equation. It determines the value of Y when X = 0. On a graph, it identifies the point where the line intercepts the Y-axis. Computed as a = M_Y − bMₓ." },
    { term: "Regression equation for Y (Ŷ = bX + a)", definition: "The linear equation where the constant b is the slope and the constant a is the Y-intercept. This equation results in the least squared error between the data points and the line." },
    { term: "Y-hat (Ŷ)", definition: "For each X value in the data, the linear equation determines a Y value on the line. This value is the predicted Y and is called Ŷ ('Y hat')." },
    { term: "Standard error of estimate", definition: "A measure of the standard distance between the predicted Ŷ values on the regression line and the actual Y values in the data. It quantifies the accuracy of predictions made by the regression equation." }
  ]
};
