                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      {/* Chapter Number */}
                      <div className={`w-14 h-14 rounded-xl flex items-center justify-center bg-gradient-to-br ${chapter.color} text-white font-bold ${chapter.isGlossaryChapter || chapter.isPracticeExam ? 'text-xs' : 'text-xl'} shadow-md group-hover:scale-105 transition-transform`}>
                        {chapter.isGlossaryChapter ? '📚' : chapter.isPracticeExam ? '📝' : chapter.id}
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          <h3 className="text-lg font-semibold text-foreground">
                            {chapter.isGlossaryChapter || chapter.isPracticeExam ? chapter.title : `Chapter ${chapter.id}: ${chapter.title}`}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {chapter.questionCount > 0 && !chapter.isGlossaryChapter && !chapter.isPracticeExam && (
